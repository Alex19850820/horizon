...
<section class="form" id="jsForm">
	<div class="container">
		<div class="form-block">
			...
			<p class="form-text">
				<span>Выбирая нас</span>
				в качестве партнера,<span>
					Вы получаете надежные деловые отношения,
				</span> основанные на взаимных интересах, успех вашего бизнеса - это цель всей нашей команды!
			</p>
			<form class="form-review" id="z_form">
				...
				<div class="form-review__btn-block">
					...
					<div class="form-review__btn-block__checkbox"><input class="form-review__btn-block__checkbox__check" type="checkbox" id="checkbox"/>
						<label class="form-review__btn-block__checkbox__label" for="checkbox">
